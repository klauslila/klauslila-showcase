...
|---|---|---|
| Page | One HTML file · precompiled React 18 · no build step | 212 KB, 35 components, 153 element calls |
...
| Data | Live ADS-B through the pinned proxy · runtime IATA lookup | 60 commits since 2026-04-01 |
<!-- stats:end:selfstats -->
