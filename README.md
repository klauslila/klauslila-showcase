...
|---|---|---|
| Page | One HTML file · precompiled React 18 · no build step | 216 KB, 36 components, 157 element calls |
...
| Data | Live ADS-B through the pinned proxy · runtime IATA lookup | 74 commits since 2026-04-01 |
<!-- stats:end:selfstats -->
